...
<div class="bookingForm" id="bookingForm">
    <div class="box">
        <a href="javascript:void(0)" class="btnClose"><i class="fas fa-times"></i></a>
        <div class="contents">
            ...
            <form action="booking.html" method="POST">
                ...
                <div class="item_group">
                    ...
                    <div class="item w40" id="person">
                        <div class="item w100">
                            <label><?= $data_index['getkeys']['bookingFrom_labelPeople'] ?></label>
                            <input type="text" name="data_post[numPerson]" placeholder="<?= $data_index['getkeys']['bookingFrom_placeholderPeople'] ?>" class="text" />
                        </div>
                    </div>
                </div>
                <div class="itemBtn">
