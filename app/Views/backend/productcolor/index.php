...
<div class="row">
	<div class="col-12">
		<div class="page-title-box">
			...
			<h4 class="page-title"><?= $title ?>: <?=$productRow['name']?></h4>
		</div>
	</div>
</div>
<!-- end page title -->
	...
	<div class="col-lg-12">
		<div class="card-box clearfix">
			<div class="form-group">
				...
				<a href="<?= CPANEL . "product/index" ?>" class="btn btn-success"><i class="icon-action-undo"></i> Quay lại</a>
			</div>
			<!-- box thông báo -->
			...
			<table id="datatable" class="table table-bordered  dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
				<thead class="thead-light">
					<tr>
						...
						<th class="text-center nosort" width="80px">Màu</th>
					...
					<?php if (isset($datas) && $datas != null) { ?>
						<?php foreach ($datas as $key => $val) { ?>
							<tr class="tr<?= $val['id'] ?>">
								...
								<td><?= $val['name'] ?></td>
								<td>
									<div class="box-color" style="background-color:<?= $val['color_code'] ?>"></div>
								</td>
								<td class="text-center"><img src="<?= $path_dir_thumb . $val['thumb'] ?>" width="60" alt=""></td>
