...
<link rel="stylesheet" href="assets/cpanel/dropzone/dropzone.min.css">
...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="card-box">
            <form action="" name="pForm" class="parsley-examples" id="addForm" method="post" enctype='multipart/form-data'>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" onkeyup="checkcode(this);" autocomplete="off" id="code" class="form-control" data-control="<?= $control ?>" placeholder="Mã sản phẩm" name="data_post[code]">
                            ...
                            <div class="form-group">
                                <div id="multi_content">
                                    <div class="row mb-3 form__items">
                                        <div class="col-4">
                                            <label for="">Tiêu đề</label>
                                            <input type="text" class="form-control"  placeholder ="Nội dung" name="data_content[0][name]">
                                        </div>
                                        <div class="col-4">
                                            <label for="">Dữ liệu</label>
                                            <input type="text" class="form-control"  placeholder ="Nội dung" name="data_content[0][data]">
                                        </div>
                                        <div class="col-2">
                                            <label for="">Số thứ tự</label>
                                            <input type="text" class="form-control text-center" value="1" name="data_content[0][number]">
                                        </div>
                            ...
                            <?php foreach ($productinfos as $key_productinfo => $val_productinfo) { ?>
                                <div class="col-6">
                                    <div class="form-group mb-0">
                                        <div class="checkbox checkbox-purple">
                                            <input id="productinfo<?=$val_productinfo['id']?>" type="checkbox" value="<?=$val_productinfo['id']?>" name="data_post_productinfo[]">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="subject" class="form-control" name="data_post[subject]">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label>&nbsp;</label>
                            <input type="text" id="subject2" class="form-control" name="data_post[subject2]">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label>&nbsp;</label>
                            <input type="text" id="subject3" class="form-control" name="data_post[subject3]">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label>Thông tin khác</label>
                            <input type="text" id="orther" class="form-control" name="data_post[orther]">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label>&nbsp;</label>
                            <input type="text" id="orther2" class="form-control" name="data_post[orther2]">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea name="data_post[content2]" id="" class="form-control ckeditor" cols="30" rows="5"></textarea>
                        </div>
                    </div>
                </div>
                <div class="clear height20"></div>
