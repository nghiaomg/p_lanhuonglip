						...
						<div class="row">
							<div class="col-6">
								...
								<div class="form-group">
									...
									<textarea name="data_post[des]" class="form-control" id="" cols="30" rows="3"><?= isset($config)?$config['des']:'' ?></textarea>
									<script>
							...
							<div class="col-6">
								<div class="form-group">
									...
									<textarea name="data_post[content]" class="form-control" id="" cols="30" rows="5"><?= isset($config)?$config['content']:'' ?></textarea>
								</div>
							</div>
							<div class="col-12">
								<div class="form-group">
