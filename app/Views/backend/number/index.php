						...
						<div class="row">
							<div class="col-6">
								<div class="form-group">
									...
									<div class="row">
										<div class="col-6">
											<input type="text" class="form-control" name="data_post[title1]" value="<?= isset($config)?$config['title1']:'' ?>">
										</div>
										<div class="col-6">
											<input type="text" class="form-control" name="data_post[title2]" value="<?= isset($config)?$config['title2']:'' ?>">
										</div>
									</div>
								</div>
								<div class="form-group">
									<label for="">Mô tả</label>
									<textarea name="data_post[des]" id="" cols="30" rows="5" class="form-control"><?= isset($config)?$config['des']:'' ?></textarea>
								</div>
							</div>
							<div class="col-12">
								<div class="form-group">
