			...
			<table id="datatable" class="table table-bordered  dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
				<thead class="thead-light">
					<tr>
						...
						<th class="text-center nosort">Top</th>
						<th class="text-center nosort">Bottom</th>
					...
					<?php if (isset($datas) && $datas != null) { ?>
						<?php foreach ($datas as $key => $val) { ?>
							<tr class="tr<?= $val['id'] ?>">
								...
								<td class="text-center">
									<input type="checkbox" onclick="changeglobal(<?= $val['id'] ?>,'top')" <?= $val['top'] == 1 ? 'checked' : '' ?> id="top<?= $val['id'] ?>" class="" data-control="<?= $control ?>">
								</td>
								<td class="text-center">
									<input type="checkbox" onclick="changeglobal(<?= $val['id'] ?>,'bottom')" <?= $val['bottom'] == 1 ? 'checked' : '' ?> id="bottom<?= $val['id'] ?>" class="" data-control="<?= $control ?>">
								</td>
								<td class="text-center">
