                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="">Tên  </label>
                            <input type="text" autocomplete="off" id="name" class="form-control"  placeholder="Tên" name="data_post[name]">
                        </div>
                        <div class="form-group">
                            <label for="">Số tài khoản</label>
                            <input type="text" autocomplete="off" id="stk" class="form-control"  placeholder="Số tài khoản" name="data_post[stk]">
                        </div>
                        <div class="form-group">
                            <label for="">Địa chỉ</label>
                            <input type="text" autocomplete="off" id="bank_name" class="form-control"  placeholder="Ngân hàng" name="data_post[bank_name]">
                        </div>
