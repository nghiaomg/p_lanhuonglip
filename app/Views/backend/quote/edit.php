                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off" id="name" class="form-control" data-control="<?= $control ?>" placeholder="Tiêu đề" name="data_post[name]" value="<?= $datas != NULL ? $datas['name'] : ""; ?>">
                        </div>
                        <div class="form-group">
                            <label for="">Link </label>
                            <input type="text" autocomplete="off" id="name" class="form-control" data-control="<?= $control ?>" placeholder="Link" name="data_post[link]" value=" <?= $datas != NULL ? $datas['link'] : ""; ?>">
                        </div>
                        <div class="clear height20"></div>
                        <div class="form-group">
                            <label for="">Mô tả</label>
                            <textarea class="form-control " placeholder="Nhập mô tả..." name="data_post[des]"><?= $datas['des'] ?></textarea>
                            <script>
