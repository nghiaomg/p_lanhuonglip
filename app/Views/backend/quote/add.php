                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off" id="name" class="form-control" data-control="<?= $control ?>" placeholder="Link" name="data_post[link]">
                        </div>
                        <div class="clear height20"></div>
                        <div class="form-group">
                            <label for="">Mô tả</label>
                            <textarea class="form-control" placeholder="Nhập mô tả..." name="data_post[des]"></textarea>
                            <script>
