                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="data_post[alias]" onkeyup="createSlug(this);" data-control="<?= $control ?>" id="name" value="<?= $datas?$datas['alias']:'' ?>" parsley-trigger="change" required placeholder="Tiêu đề" class="form-control">
                        </div>
                    </div>
                    </div>
                </div>
