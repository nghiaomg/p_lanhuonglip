				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" name="data_post[name]" parsley-trigger="change" required placeholder="Nhập tên ngành nghề..." class="form-control" id="name">
							<p id="message"></p>
						</div>
						<div class="form-group">
							<div class="checkbox checkbox-info">
								<input id="publish" type="checkbox" checked value="1" name="data_post[publish]">
