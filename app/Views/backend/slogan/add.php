                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" required="" oninvalid="this.setCustomValidity('Vui lòng nhập tên')" oninput="this.setCustomValidity('')" autocomplete="off" id="name" class="form-control" data-control="<?= $control ?>" name="data_post[name]">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <div class="logo_image">
                                <label for="userName">Ảnh đại diện (Kích thước chuẩn: 300 x 300px)<span class="text-danger">*</span></label>
                                <div class="image_box">
