            ...
            <form action="" class="parsley-examples" method="post" novalidate enctype='multipart/form-data'>
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <label for="">Link video (ví dụ: <span class="text-danger">https://www.youtube.com/watch?v=GYlZ4HJDFcc</span>)</label>
                            <input type="text" autocomplete="off" id="link" class="form-control"  value="<?= $datas ? $datas['link'] : '' ?>" placeholder="Link video" name="data_post[link]">
                        </div>
                        <div class="form-group">
                            <div class="logo_image">
                                <label for="userName">Ảnh đại diện (Kích thước chuẩn: 800 x 450px)<span class="text-danger">*</span></label>
                                <div class="image_box">
