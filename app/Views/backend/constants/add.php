                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off" id="name" class="form-control"  placeholder="Từ khóa" name="data_post[name]">
                        </div>
                        <div class="form-group">
                            <label for="keys">Keys </label>
                            <input type="text" autocomplete="off" id="keys" class="form-control"placeholder="" name="data_post[key_constants]" >
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off" id="name_en" class="form-control"  placeholder="Từ khóa (Tiếng anh)" name="data_post[name_en]">
                        </div>
                    </div>
                </div>
