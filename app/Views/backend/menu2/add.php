            ...
            <div class="row">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <select name="data_post[type]" class="form-control" id="type">
                                        ...
                                        <option value="3">Link tĩnh</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-9">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required oninvalid="this.setCustomValidity('Vui lòng nhập tiêu đề')" oninput="this.setCustomValidity('')" name="data_post[name]" id="name">
                    </div>
                    <div class="form-group">
                        <label for="">Tiêu đề (Tiếng anh)</label>
                        <input type="text" class="form-control" name="data_post[name_en]" id="name_en">
                    </div>
                </div>
            </div>
