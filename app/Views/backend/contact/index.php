...
<div class="row">
    <div class="col-lg-12">
        <div class="card-box clearfix">
            <div class="form-group">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="col-4 d-flex">
                        <input type="text" id="search" class="form-control mr-2" placeholder="Nhập số điện thoại hoặc email" value="">
            ...
            <!------\ loadTable ------>
            <div id="loadTable">
                <?= $this->include('backend/contact/loadTable') ?>
            </div>
            <!------/ loadTable ------>
...
<script>
    const url_paging_search = "cpanel/contact/search_pagination";
    // tìm kiếm
