                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="">Tên</label>
                            <input type="text" onkeyup="createSlug(this);" required="" oninvalid="this.setCustomValidity('Vui lòng nhập tên')" oninput="this.setCustomValidity('')" autocomplete="off" id="name" class="form-control" data-control="<?= $control ?>" placeholder="Nhập tên công trình..." name="data_post[name]" value="<?= $datas != NULL ? $datas['name'] : ""; ?>">
                        </div>
                        <div class="form-group">
                            <label for="">Công việc</label>
                            <input type="text" autocomplete="off" id="job" class="form-control" data-control="<?= $control ?>" placeholder="Nhập công việc ..." name="data_post[job]" value="<?= $datas['job'] ?>">
                        </div>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea name="data_post[des]" id="" class=" form-control ckeditor" cols="30" rows="5"><?= $datas != NULL ? trim($datas['des']) : ""; ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="clear height20"></div>
