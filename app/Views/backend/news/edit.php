                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select name="data_post_cateid[cateid][]" class="form-control select2" multiple="multiple" data-placeholder="Chọn">
                                <?= $menu; ?>
                            </select>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="tags" value="<?= $datas ? $datas['tags'] : '' ?>" name="data_post[tags]" data-role="tagsinput">
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div id="parentMenu">
                                        <?php if(isset($parentMenu) && $parentMenu !=NULL){?>
                                            <?php foreach($parentMenu as $key => $val){?>
                                                <div class="row items_menu" data-arr = "<?= $key ?>">
                                                    <div class="col-lg-4">
                                                        <label for="">Tiêu đề</label>
                                                        <input type="text" class="form-control" value="<?= $val['title'] ?>" onkeyup="removeAccents(this)" name="data_parent[<?= $key ?>][title]" placeholder="Tiêu đề">
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <label for="">Từ khóa</label>
                                                        <input type="text" class="form-control" value="<?= $val['keywords'] ?>" id="keywords<?= $key ?>" name="data_parent[<?= $key ?>][keyword]" placeholder="Từ khóa">
                                                    </div>
                                                    <div class="col-lg-1">
                                                        <label for="">STT</label>
                                                        <input type="text" class="form-control text-center" value="<?= $val['number'] ?>" name="data_parent[<?= $key ?>][number]">
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <label for="">&nbsp;</label>
                                                    ...
                                                    <div id="submenu" class="ml-4 mt-2 col-lg-12">
                                                        <?php if(isset($val['sub']) && $val['sub']!=NULL){?>
                                                            <?php foreach($val['sub'] as $key_child => $val_child){?>
                                                                <div class="row items__sub<?= $key ?> mt-1">
                                                                    <div class="col-lg-4">
                                                                        <label for="">Tiêu đề</label>
                                                                        <input type="text" class="form-control" value="<?= $val_child['title'] ?>" onkeyup="removeAccents2(this,<?= $key ?>)" name="data_parent[<?= $key ?>][sub][<?= $key_child ?>][title]" placeholder="Tiêu đề">
                                                                    </div>
                                                                    <div class="col-lg-4">
                                                                        <label for="">Từ khóa</label>
                                                                        <input type="text" class="form-control" value="<?= $val_child['keywords'] ?>" id="subkeyword<?= $key ?>"  name="data_parent[<?= $key ?>][sub][<?= $key_child ?>][keyword]" placeholder="Từ khóa">
                                                                    </div>
                                                                    <div class="col-lg-1">
                                                                        <label for="">STT</label>
                                                                        <input type="text" class="form-control text-center" value="<?= $val_child['number'] ?>" name="data_parent[<?= $key ?>][sub][<?= $key_child ?>][number]">
                                                                    </div>
                                                                    <div class="col-lg-1">
                                                                        <label for="">&nbsp;</label>
                                                                        <div style="display:flex">
...
<script type="text/javascript">
        ...
        if (type ==="parent") {
            ...
            $('#parentMenu').append(`
                <div class="row items_menu mt-2" data-arr = "${count}">
                    <div class="col-lg-4">
                        <label for="">Tiêu đề</label>
                        <input type="text" class="form-control" onkeyup="removeAccents(this)" name="data_parent[${count}][title]" placeholder="Tiêu đề">
                    </div>
                    <div class="col-lg-4">
                        <label for="">Từ khóa</label>
            ...
            let count_sub = document.querySelectorAll('.items__sub'+counts).length - 1;
            let count = document.querySelectorAll('.items_menu').length - 1;
            $(__this).closest('.items_menu').find('#submenu').append(`
                <div class="row items__sub${counts} mt-1">
                    <div class="col-lg-4">
                        <label for="">Tiêu đề</label>
                        <input type="text" class="form-control" onkeyup="removeAccents2(this,${parse})" name="data_parent[${counts}][sub][${count_sub + 1}][title]" placeholder="Tiêu đề">
                    </div>
                    <div class="col-lg-4">
                        <label for="">Từ khóa</label>
    ...
    function DeleteMenu(type,__this){
        ...
        if (type ==="parent") {
            ...
            count_sub--;
            $(__this).closest('.items__sub'+counts).remove();
        }
    }
    function removeAccents(str) {
        ...
        $('#keywords'+count).val(substr);
       
    }
    function removeAccents2(str,num) {
        let substr = str.value;
        let count_sub = document.querySelectorAll('.items__sub'+num).length - 1;
        var AccentsMap = [
            "aàảãáạăằẳẵắặâầẩẫấậ",
            "AÀẢÃÁẠĂẰẲẴẮẶÂẦẨẪẤẬ",
            "dđ", "DĐ",
