                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off" id="name" class="form-control"placeholder="Tiêu đề" name="data_post[name]" value="<?= $datas != NULL ? $datas['name'] : ""; ?>">
                        </div>
                        <div class="form-group">
                            <label for="">Địa chỉ </label>
                            <input type="text" autocomplete="off" id="address" class="form-control"  placeholder="Địa chỉ" name="data_post[address]"  value="<?= $datas != NULL ? $datas['address'] : ""; ?>">
                        </div>
                        <div class="form-group">
                            <label for="">Số điện thoại </label>
                            <input type="text" autocomplete="off" id="phone" class="form-control"  placeholder="Số điện thoại " value="<?= $datas != NULL ? $datas['phone'] : ""; ?>" name="data_post[phone]">
                        </div>
                        <div class="form-group">
                            <label for="">Email</label>
                            <input type="text" autocomplete="off" id="email" class="form-control"  placeholder="Email"  value="<?= $datas != NULL ? $datas['email'] : ""; ?>" name="data_post[email]" >
                        </div>
                        <div class="form-group">
                            <label for="">Thời gian làm việc</label>
                            <input type="text" autocomplete="off" id="timework" class="form-control"  placeholder="Thời gian làm việc"  value="<?= $datas != NULL ? $datas['timework'] : ""; ?>" name="data_post[timework]" >
                        </div>
                        <div class="form-group">
