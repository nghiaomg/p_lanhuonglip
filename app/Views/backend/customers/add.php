        ...
        <div class="card-box">
            <form action="" class="parsley-examples" method="post"  enctype='multipart/form-data'>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" class="form-control"  placeholder="Họ và tên" name="data_post[name]">
                            <small></small>
                        </div>
                        <div class="form-group">
                            <label for="">Địa chỉ </label>
                            <input type="text" id="address" class="form-control"  placeholder="Địa chỉ" name="data_post[address]">
                            <small></small>
                        </div>
                        <div class="form-group">
                            <label for="">Số điện thoại </label>
                            <input type="text" id="phone" class="form-control"  placeholder="Số điện thoại" name="data_post[phone]">
                            <small></small>
                        </div>
                        <div class="form-group">
                            <label for="">Email</label>
                            <input type="text" id="email" class="form-control"  placeholder="Email" name="data_post[email]">
                            <small></small>
                        </div>
                    </div>
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <label for="male">
                                    Nam: <input type="radio" checked  name="data_post[sex]" id="male" value="1">
                                </label>
                                <label for="female">
                                    Nữ: <input type="radio" name="data_post[sex]" id="female" value="2">
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Ngày sinh</label>
                            <input type="text"  name="data_post[birthday]" placeholder="Ngày sinh" class="text form-control" id="birthday"  data-inputmask="'alias': 'date'"/>
                            <small></small>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group text-left mb-0 col-lg-12 mt-1 d-flex justify-content-center">
                    <button class="btn btn-primary waves-effect waves-light mr-1" id="submitAdd">
                        Lưu
                    </button>
...
<script>
    ...
    $('#submitAdd').click(async function(e){
        ...
        let checkData = await checkPhoneAndEmail($(this).closest('form').serialize());
    ...
    function checkPhoneAndEmail(data){
        return new Promise((relsove,reject)=>{
            $.ajax({
                url:"cpanel/"+"<?= $control ?>/checkData",
                method:"post",
                data:data,
                dataType:'json',
