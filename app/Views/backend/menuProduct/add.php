            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" onkeyup="createSlug(this);" autocomplete="off" id="name" class="form-control" data-control="<?= $control ?>" placeholder="Tiêu đề" name="data_post[name]">
                    </div>
                    <div class="form-group">
                        <label>Slug</label>
                    ...
                    <div class="form-group">
                        <div class="logo_image">
                            ...
                            <div class="image_box">
                                <img id="preview" class="w-50" src="assets/images/no_img.png" alt="Ảnh đại diện" title=''/>
                            </div>
                            <div>
