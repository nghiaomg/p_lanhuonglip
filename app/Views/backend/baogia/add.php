                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="data_post[link]" parsley-trigger="change" placeholder="Tiêu đề" class="form-control" id="link">
                        </div>
                        <div class="form-group">
                            <label for="price">Giá</label>
                            <input type="text" name="data_post[price]" parsley-trigger="change" onkeyup = "FormatNumber(this)" required placeholder="200,000" class="form-control" id="price">
                        </div>
                        <div class="form-group">
                            <label for="price">Giá khuyến mãi</label>
                            <input type="text" name="data_post[price_sale]" onkeyup = "FormatNumber(this)" required placeholder="200,000" class="form-control" id="price">
                        </div>
                        <div class="form-group">
                                ...
                                <div class="col-12 mt-2 form__items">
                                    <div class="row">
                                        ...
                                        <div class="col-2">
                                            ...
                                            <input type="text" class="form-control text-center" placeholder =""value="0" name="data_content[0][number]">
                                        </div>
                                        <div class="col-2 d-flex align-items-end">
                                            <button type="button" onclick="ActionAvg('delete_en',this)" class="del_btn btn btn-dark waves-effect waves-light"> <i class="fas fa-trash-alt "></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
