...
{
    private $title                  = 'album';
    private $template               = 'backend/album/';
    public $control                 = 'album';
    public $path_url                = 'cpanel/album/';
    public $path_dir                = 'uploads/images/album/';
    public $path_dir_webp           = 'uploads/webps/album/';
    ...
    public function index()
    {
        ...
        $datas      = $this->AlbumModels->select_array();
    ...
    function add()
    {
        ...
        $data_index = $this->get_indexBE();
        $sort_max   = $this->AlbumModels->select_max('sort');
        ...
        if ($this->request->getPost()) {
            ...
            if ($_FILES['image']['name']) {
                ...
                $data_upload              = $this->Upload->upload_image($this->path_dir, $fileName, $_FILES['image']['name'], 'image', 500, 500, null, "webp");
            ...
            $result = $this->AlbumModels->add($data_post);
    ...
    function edit($id)
    {
        ...
        $data_index = $this->get_indexBE();
        $datas           = $this->AlbumModels->find_one($id);
        $sort_max   = $this->AlbumModels->select_max('sort');
        ...
        if ($this->request->getPost()) {
            ...
            $result                         = $this->AlbumModels->edit($data_post, array('id' => $id));
    ...
    function delete()
    {
        ...
        $id            = $_POST['id'];
        $datas         = $this->AlbumModels->where_in(array('id' => $id));
        ...
        if ($datas != NULL) {
            ...
            $result = $this->AlbumModels->deleteWhere(array('id' => $id));
        }
    }
    ...
    function deleteAll()
    {
        ...
        foreach ($list_id_delete as $key => $val) {
            $datas         = $this->AlbumModels->where_in(array('id' => $val));
            $filename      = $this->path_dir . $datas['image'];
            $filenamethumb = $this->path_dir . $datas['thumb'];
            ...
            $result = $this->AlbumModels->deleteWhere(array('id' => $val));
            if ($result) {
    ...
    function checkglobals()
    {
        ...
        $result                  = $this->AlbumModels->edit($dataUpdate, array('id' => $id));
    ...
    public function sort()
    {
        ...
        $result              = $this->AlbumModels->edit($data_update, array('id' => $id));
