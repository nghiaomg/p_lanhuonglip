...
{
    private $title                  = 'instagram';
    private $template               = 'backend/instagram/';
    public $control                 = 'instagram';
    public $path_url                = 'cpanel/instagram/';
    public $path_dir                = 'uploads/images/instagram/';
    public $path_dir_webp           = 'uploads/webps/instagram/';
    ...
    public function index()
    {
        ...
        $datas      = $this->InstagramModels->select_array();
    ...
    function add()
    {
        ...
        $data_index = $this->get_indexBE();
        $sort_max   = $this->InstagramModels->select_max('sort');
        ...
        if ($this->request->getPost()) {
            ...
            $result = $this->InstagramModels->add($data_post);
    ...
    function edit($id)
    {
        ...
        $data_index = $this->get_indexBE();
        $datas           = $this->InstagramModels->find_one($id);
        $sort_max   = $this->InstagramModels->select_max('sort');
        ...
        if ($this->request->getPost()) {
            ...
            $result                         = $this->InstagramModels->edit($data_post, array('id' => $id));
    ...
    function delete()
    {
        ...
        $id            = $_POST['id'];
        $datas         = $this->InstagramModels->where_in(array('id' => $id));
        ...
        if ($datas != NULL) {
            ...
            $result = $this->InstagramModels->deleteWhere(array('id' => $id));
        }
    }
    ...
    function deleteAll()
    {
        ...
        foreach ($list_id_delete as $key => $val) {
            $datas         = $this->InstagramModels->where_in(array('id' => $val));
            $filename      = $this->path_dir . $datas['image'];
            $filenamethumb = $this->path_dir . $datas['thumb'];
            ...
            $result = $this->InstagramModels->deleteWhere(array('id' => $val));
            if ($result) {
    ...
    function checkglobals()
    {
        ...
        $result                  = $this->InstagramModels->edit($dataUpdate, array('id' => $id));
    ...
    public function sort()
    {
        ...
        $result              = $this->InstagramModels->edit($data_update, array('id' => $id));
